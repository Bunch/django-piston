...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('piston_nonce', ['id', 'token_key', 'consumer_key', 'key'])

    def backwards(self, orm):
        db.delete_index('piston_nonce', ['id', 'token_key', 'consumer_key', 'key'])
    ...
    models = {
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1361978679L'}),
